...
INSERT INTO Status_Projeto (nome, descricao)
VALUES ('Em Andamento', 'Projeto está em progresso'),
...
INSERT INTO Projeto (nome, descricao, data_inicio, data_fim, data_criacao, Status_ProjetoID, LiderID)
...
INSERT INTO Quadro (titulo, ProjetoID)
VALUES ('Quadro Principal', 2025100),
       ('Urgente', 2025100),
       ('Quadro A', 2025101),
       ('Quadro B', 2025101),
       ('Quadro C', 2025102),
...
INSERT INTO Status_Tarefa (nome, descricao, ProjetoID)
VALUES ('Nova', 'Tarefa recém-criada', 2025100),
       ('Em andamento', 'Tarefa em execução', 2025100),
       ('Concluída', 'Tarefa finalizada', 2025100),
       ('Bloqueada', 'Tarefa com impedimentos', 2025100);


INSERT INTO Tarefa (nome, descricao, posicao, data_inicio, data_fim, data_criacao, prioridade, Status_TarefaID, QuadroID, ListaID, CriadorID,
                    ResponsavelID)
VALUES ('Criar Banco', 'Definir estrutura SQL', 1, '2025-01-01', '2025-01-05', GETDATE(), 1, 1, 2025101, 1, 10000, 10001),
...
INSERT INTO Comentario (TarefaID, UsuarioID, texto)
VALUES (10000, 10000, 'Início da modelagem'),
